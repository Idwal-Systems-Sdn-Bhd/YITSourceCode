...
namespace YIT._DataAccess.Repositories.Interfaces
{
    public interface IAkBelianRepository : _IGenericRepository<AkBelian>
    {
        ...
        public Task<List<AkBelian>> GetResultsGroupByTarikh(string? tarikhDari, string? tarikhHingga, int? dDaftarAwamId, int? dDaftarAwamId1);
        public Task<List<AkBelian>> GetResultsGroupByTarikh1(string? tarikhDari, string? tarikhHingga, int? jKWId);
        public Task<decimal> GetKredit(string? tarikhDari, string? tarikhHingga, int? dDaftarAwamId, int? dDaftarAwamId1);

...
namespace YIT._DataAccess.Services.Cart.Session
{
    public class SessionCartAkBelian : CartAkBelian
    {
        ...
        //BelianPerihal
        public override void AddItemPerihal(int akBelianId, decimal bil, string? perihal, decimal kuantiti, string? unit, decimal harga, decimal amaun)
        {
            base.AddItemPerihal(akBelianId, bil, perihal, kuantiti, unit, harga, amaun);
            Session?.SetJson("CartAkBelian", this);
        }

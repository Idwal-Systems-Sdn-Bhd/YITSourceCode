...
namespace YIT.Akaun.Controllers._03Akaun
{
    ...
    public class AkJurnalLulusController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public const string namamodul = Modules.namaLulusAkJurnal;
        ...
        public AkJurnalLulusController(
            ...
            string password)
        {
            ...
            if (dKonfigKelulusanId != null)
            {
                ...
                if (_unitOfWork.DKonfigKelulusanRepo.IsValidUser((int)dKonfigKelulusanId, password, EnJenisModulKelulusan.Jurnal, EnKategoriKelulusan.Pelulus) == false)
                {
                ...
                else
                {
                    ...
                    akJurnal = _unitOfWork.AkJurnalRepo.GetResultsByDPekerjaIdFromDKonfigKelulusan(searchString, date1, date2, searchColumn, EnStatusBorang.Semak, (int)dKonfigKelulusanId, EnKategoriKelulusan.Pelulus, EnJenisModulKelulusan.Jurnal);
        ...
        public async Task<IActionResult> Lulus(int id, int dKonfigKelulusanId, string syscode)
        {
            ...
            if (akJurnal != null)
            {
                ...
                _unitOfWork.AkJurnalRepo.Lulus(id, dKonfigKelulusanId, user?.UserName ?? "");

                _appLog.Insert("Posting", "Melulus " + akJurnal.NoRujukan ?? "" + "; pelulusId: " + dKonfigKelulusanId.ToString(), akJurnal.NoRujukan ?? "", id, akJurnal.JumlahDebit, pekerjaId, modul, syscode, namamodul, user);

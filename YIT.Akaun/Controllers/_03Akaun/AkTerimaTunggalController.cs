...
namespace YIT.Akaun.Controllers._03Akaun
{
    ...
    public class AkTerimaTunggalController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        // printing akTerimaTunggal
        [AllowAnonymous]
        public async Task<IActionResult> PrintPDFById(int id)
        {
            AkTerimaTunggal akTerimaTunggal = _unitOfWork.AkTerimaTunggalRepo.GetDetailsById(id);
            ...
            return new ViewAsPdf(modul + EnJenisFail.PDF, akTerimaTunggal,

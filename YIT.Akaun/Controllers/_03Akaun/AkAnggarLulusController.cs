...
{
    [Authorize]
    public class AkAnggarLulusController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public AkAnggarLulusController(
            ...
            string password)
        {
            ...
            if (dKonfigKelulusanId != null)
            {
                ...
                if (_unitOfWork.DKonfigKelulusanRepo.IsValidUser((int)dKonfigKelulusanId, password, EnJenisModulKelulusan.AnggaranHasil, EnKategoriKelulusan.Pelulus) == false)
                {
                ...
                else
                {
                    ...
                    akAnggar = _unitOfWork.AkAnggarRepo.GetResultsByDPekerjaIdFromDKonfigKelulusan(searchString, date1, date2, searchColumn, EnStatusBorang.Semak, (int)dKonfigKelulusanId, EnKategoriKelulusan.Pelulus, EnJenisModulKelulusan.AnggaranHasil);
        ...
        public async Task<IActionResult> Lulus(int id, int dKonfigKelulusanId, string syscode)
        {
            ...
            if (akAnggar != null)
            {
                ...
                _unitOfWork.AkAnggarRepo.Lulus(id, dKonfigKelulusanId, user?.UserName ?? "");

                _appLog.Insert("Posting", "Melulus " + akAnggar.NoRujukan ?? "" + "; pelulusId: " + dKonfigKelulusanId.ToString(), akAnggar.NoRujukan ?? "", id, akAnggar.Jumlah, pekerjaId, modul, syscode, namamodul, user);
        ...
        private void PopulateFormFields(string searchString, string password, string searchDate1, string searchDate2)
        {
            ...
            ViewBag.DKonfigKelulusan = _unitOfWork.DKonfigKelulusanRepo.GetResultsByCategoryGroupByDPekerja(EnKategoriKelulusan.Pelulus, EnJenisModulKelulusan.AnggaranHasil);
        }

...
{
    [Authorize]
    public class AkJurnalSemakController : Microsoft.AspNetCore.Mvc.Controller
    {
        public const string modul = Modules.kodSemakAkJurnal;
        public const string namamodul = Modules.namaSemakAkJurnal;
        ...
        public AkJurnalSemakController(
            ...
            string password)
        {
            ...
            if (dKonfigKelulusanId != null)
            {
                ...
                if (_unitOfWork.DKonfigKelulusanRepo.IsValidUser((int)dKonfigKelulusanId, password, EnJenisModulKelulusan.Jurnal, EnKategoriKelulusan.Penyemak) == false)
                {
                ...
                else
                {
                    ...
                    akJurnal = _unitOfWork.AkJurnalRepo.GetResultsByDPekerjaIdFromDKonfigKelulusan(searchString, date1, date2, searchColumn, EnStatusBorang.Sah, (int)dKonfigKelulusanId, EnKategoriKelulusan.Penyemak, EnJenisModulKelulusan.Jurnal);
        ...
        public async Task<IActionResult> Semak(int id, int dKonfigKelulusanId, string syscode)
        {
            ...
            if (akJurnal != null)
            {
                ...
                _unitOfWork.AkJurnalRepo.Semak(id, dKonfigKelulusanId, user?.UserName ?? "");

                _appLog.Insert("Posting", "Menyemak " + akJurnal.NoRujukan ?? "" + "; penyemakId: " + dKonfigKelulusanId.ToString(), akJurnal.NoRujukan ?? "", id, akJurnal.JumlahDebit, pekerjaId, modul, syscode, namamodul, user);

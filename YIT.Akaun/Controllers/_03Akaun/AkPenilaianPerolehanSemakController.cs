    ...
    public class AkPenilaianPerolehanSemakController : Microsoft.AspNetCore.Mvc.Controller
    {
            ...
            string password)
        {
            ...
            if (dKonfigKelulusanId != null)
            {
                ...
                if (_unitOfWork.DKonfigKelulusanRepo.IsValidUser((int)dKonfigKelulusanId, password, EnJenisModul.Perolehan,EnKategoriKelulusan.Penyemak) == false)
                {
                ...
                else
                {
                    ...
                    akPP = _unitOfWork.AkPenilaianPerolehanRepo.GetResultsByDPekerjaIdFromDKonfigKelulusan(searchString, date1, date2, searchColumn, EnStatusBorang.Sah, (int)dKonfigKelulusanId,EnKategoriKelulusan.Penyemak, EnJenisModul.Perolehan);
        ...
        private void PopulateFormFields(string searchString, string password, string searchDate1, string searchDate2)
        {
            ...
            ViewBag.DKonfigKelulusan = _unitOfWork.DKonfigKelulusanRepo.GetResultsByCategoryGroupByDPekerja(EnKategoriKelulusan.Penyemak, EnJenisModul.Perolehan);
        }
    }
}

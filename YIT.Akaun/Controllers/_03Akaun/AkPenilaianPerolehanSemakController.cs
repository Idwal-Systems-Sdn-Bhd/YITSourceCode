...
namespace YIT.Akaun.Controllers._03Akaun
{
    ...
    public class AkPenilaianPerolehanSemakController : Microsoft.AspNetCore.Mvc.Controller
    {
        public const string modul = Modules.kodSemakAkPenilaianPerolehan;
        public const string namamodul = Modules.namaSemakAkPenilaianPerolehan;
        ...
        public AkPenilaianPerolehanSemakController(
            ...
            string password)
        {
            ...
            if (dKonfigKelulusanId != null)
            {
                ...
                if (_unitOfWork.DKonfigKelulusanRepo.IsValidUser((int)dKonfigKelulusanId, password, EnJenisModulKelulusan.Penilaian,EnKategoriKelulusan.Penyemak) == false)
                {
                ...
                else
                {
                    ...
                    akPP = _unitOfWork.AkPenilaianPerolehanRepo.GetResultsByDPekerjaIdFromDKonfigKelulusan(searchString, date1, date2, searchColumn, EnStatusBorang.Sah, (int)dKonfigKelulusanId,EnKategoriKelulusan.Penyemak, EnJenisModulKelulusan.Penilaian);
        ...
        public async Task<IActionResult> Semak(int id, int dKonfigKelulusanId, string syscode)
        {
            ...
            if (akPP != null)
            {
                ...
                _unitOfWork.AkPenilaianPerolehanRepo.Semak(id, dKonfigKelulusanId, user?.UserName ?? "");

                _appLog.Insert("Posting", "Menyemak " + akPP.NoRujukan ?? "" + "; penyemakId: " + dKonfigKelulusanId.ToString(), akPP.NoRujukan ?? "", id, akPP.Jumlah, pekerjaId, modul, syscode, namamodul, user);
        ...
        private void PopulateFormFields(string searchString, string password, string searchDate1, string searchDate2)
        {
            ...
            ViewBag.DKonfigKelulusan = _unitOfWork.DKonfigKelulusanRepo.GetResultsByCategoryGroupByDPekerja(EnKategoriKelulusan.Penyemak, EnJenisModulKelulusan.Penilaian);
        }
    }
}

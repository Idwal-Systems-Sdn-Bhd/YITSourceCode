...
namespace YIT.Akaun.Controllers._03Akaun
{
    ...
    public class AkIndenLulusController : Microsoft.AspNetCore.Mvc.Controller
    {
                ...
                string password)
        {
            ...
            if (dKonfigKelulusanId != null)
            {
                ...
                else
                {
                    ...
                    akInden = _unitOfWork.AkIndenRepo.GetResultsByDPekerjaIdFromDKonfigKelulusan(searchString, date1, date2, searchColumn, EnStatusBorang.None, (int)dKonfigKelulusanId, EnKategoriKelulusan.Pelulus, EnJenisModul.Tanggungan);
        ...
        private void PopulateFormFields(string searchString, string password, string searchDate1, string searchDate2)
        {
            ...
            ViewBag.DKonfigKelulusan = _unitOfWork.DKonfigKelulusanRepo.GetResultsByCategoryGroupByDPekerja(EnKategoriKelulusan.Pelulus,EnJenisModul.Tanggungan);
        }
